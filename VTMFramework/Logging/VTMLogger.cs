...

{
    class VTMLogger : VtmFramework.Logging.IVtmLogger
    {
        ...
        private static string _defaultLogPath = Environment.ExpandEnvironmentVariables("%userprofile%");  //Environment.ExpandEnvironmentVariables("%userprofile%") + @"\AppData\VTMTrafficMonitor\VTM_Log.log";
